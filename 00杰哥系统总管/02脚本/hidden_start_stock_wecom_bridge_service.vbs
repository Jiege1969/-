' Name: hidden_start_stock_wecom_bridge_service.vbs
' System: 00杰哥系统总管 / 02脚本
' Purpose: Launch stock WeCom bridge starter without showing a console window.
' Trigger: Windows Scheduled Task 杰哥智能化系统_股票企业微信桥接入口服务.
' Dependencies: start_stock_wecom_bridge_service_entry.ps1; Windows Script Host.
...
psScript = fso.BuildPath(scriptDir, "start_stock_wecom_bridge_service_entry.ps1")
