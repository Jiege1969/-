' Name: hidden_start_daily_readonly_audit.vbs
' System: 00杰哥系统总管 / 02脚本
' Purpose: Launch daily readonly system audit without showing a console window.
' Trigger: Windows Scheduled Task 杰哥智能化系统_每日只读巡检.
' Dependencies: daily_readonly_audit_entry.ps1; Windows Script Host.
...
psScript = fso.BuildPath(scriptDir, "daily_readonly_audit_entry.ps1")
