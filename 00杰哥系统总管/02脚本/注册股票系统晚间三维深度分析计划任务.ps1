...
$taskName = U @(0x6770,0x54e5,0x667a,0x80fd,0x5316,0x7cfb,0x7edf,0x5f,0x80a1,0x7968,0x5f,0x665a,0x95f4,0x4e09,0x7ef4,0x6df1,0x5ea6,0x5206,0x6790)
$argument = "-NoProfile -NonInteractive -ExecutionPolicy Bypass -File `"$entry`" -Stage night"
