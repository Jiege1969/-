' Name: hidden_start_intention_api_service.vbs
' System: 00杰哥系统总管 / 02脚本
' Purpose: Launch intention API starter without showing a console window.
' Trigger: Windows Scheduled Task 杰哥智能化系统_意图归因API服务.
' Dependencies: start_intention_api_service_entry.ps1; Windows Script Host.
...
psScript = fso.BuildPath(scriptDir, "start_intention_api_service_entry.ps1")
