...
class SafeCiCheckTests(unittest.TestCase):
    ...
    def test_circleci_allowed_commands_match_current_config(self):
        ...
        self.assertIn("python ci/stock_citic_pool_contract_ci_check.py", commands)
        ...
        self.assertIn("python ci/stock_dependency_order_ci_check.py", commands)
    ...
    def test_stock_citic_pool_contract_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_citic_pool_contract_ci_check.py"
    ...
    def test_stock_sample_pool_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_sample_pool_ci_check.py"
        self.assertTrue(checker.exists())
    ...
    def test_stock_review_loop_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_review_loop_ci_check.py"
        self.assertTrue(checker.exists())

    def test_stock_safe_boundary_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_safe_boundary_ci_check.py"
        self.assertTrue(checker.exists())
    ...
    def test_stock_ci_learning_summary_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_ci_learning_summary.py"
        self.assertTrue(checker.exists())
    ...
    def test_stock_dependency_order_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_dependency_order_ci_check.py"
        self.assertTrue(checker.exists())

    def test_stock_risk_matrix_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_risk_matrix_ci_check.py"
        self.assertTrue(checker.exists())

    def test_stock_acceptance_overview_ci_checker_exists(self):
        checker = safe_ci_check.ROOT / "ci" / "stock_acceptance_overview_ci_check.py"
        self.assertTrue(checker.exists())
