...
ASSET_JSON = ROOT / "03数据" / "70第二轮并行施工调度索引与合并验收准备包" / "第二轮并行施工调度索引与合并验收准备包_最新.json"
LOG_DIR = ROOT / "04日志" / "第二轮并行施工调度索引与合并验收准备包验收"
LATEST_LOG = LOG_DIR / "parallel-round2-dispatch-merge-prepare-verify-最新.json"
...
def main() -> int:
    ...
    if asset.get("状态") != "parallel_round2_dispatch_merge_prepare_ready":
        errors.append("状态必须为 parallel_round2_dispatch_merge_prepare_ready")
