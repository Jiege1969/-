...
ASSET_JSON = ROOT / "03数据" / "76第四轮低风险能力前置并行调度索引包" / "第四轮低风险能力前置并行调度索引包_最新.json"
LOG_DIR = ROOT / "04日志" / "第四轮低风险能力前置并行调度索引包验收"
LATEST_LOG = LOG_DIR / "parallel-round4-low-risk-capability-prepare-verify-最新.json"
...
def main() -> int:
    ...
    if asset.get("状态") != "parallel_round4_low_risk_capability_prepare_ready":
        errors.append("状态不正确")
