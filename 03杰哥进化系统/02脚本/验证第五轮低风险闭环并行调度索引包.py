...
ASSET_JSON = ROOT / "03数据" / "79第五轮低风险闭环并行调度索引包" / "第五轮低风险闭环并行调度索引包_最新.json"
LOG_DIR = ROOT / "04日志" / "第五轮低风险闭环并行调度索引包验收"
LATEST_LOG = LOG_DIR / "parallel-round5-low-risk-loop-prepare-verify-最新.json"
...
def main() -> int:
    ...
    if asset.get("状态") != "parallel_round5_low_risk_loop_prepare_ready":
        errors.append("状态不正确")
