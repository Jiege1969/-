...
本脚本只生成调度索引，作为总管主控合并验收入口；不触发业务接口。
"""
...
OUTPUT_DIR = EVOLUTION_ROOT / "03数据" / "79第五轮低风险闭环并行调度索引包"
LATEST_JSON = OUTPUT_DIR / "第五轮低风险闭环并行调度索引包_最新.json"
LATEST_MD = OUTPUT_DIR / "第五轮低风险闭环并行调度索引包_最新.md"
...
TASKS: list[dict[str, Any]] = [
    {
        ...
        "业务域": "进化系统",
        "目标": "把反馈候选推进到可复跑、可去重、可人工确认的台账预演。",
        "验收日志": str(
            EVOLUTION_ROOT
            / "04日志"
            / "三业务反馈候选复跑去重与人工确认台账包验收"
            / "three-business-feedback-rerun-dedupe-ledger-verify-最新.json"
        ),
    },
    {
        "编号": "ROUND5-N",
        "名称": "n8n离线干跑多场景回归与闸口矩阵包",
        "业务域": "进化系统",
        "目标": "把 n8n 离线干跑推进到多场景回归和闸口矩阵。",
        "验收日志": str(
            EVOLUTION_ROOT
            / "04日志"
            / "n8n离线干跑多场景回归与闸口矩阵包验收"
            / "n8n-offline-multiscenario-gate-matrix-verify-最新.json"
        ),
    },
    {
        "编号": "ROUND5-O",
        ...
        "业务域": "视频制作系统",
        "目标": "把视频真实渲染前置核对推进到总闸口和人工放行申请草案。",
        "验收日志": str(
            ROOT
            / "02杰哥扩展系统"
            / "02视频制作系统"
            / "04日志"
            / "真实渲染启用前总闸口与人工放行申请包验收"
